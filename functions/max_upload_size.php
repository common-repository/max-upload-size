...
add_action('admin_menu', 'mups_upload_max_file_size_add_pages5');
...
if ( !function_exists( 'mups_upload_max_file_size_add_pages5' ) ) {



	function mups_upload_max_file_size_add_pages5() {
...
function mups_upload_max_file_size5() {
...
function mups_upload_max_increase_upload4() {
...
function mups_max_display_options3() {
...
function mups_max_display_header_options_content4() {
...
function mups_max_display_logo_form_element2() {
...
add_action("admin_init", "mups_max_display_options2");
